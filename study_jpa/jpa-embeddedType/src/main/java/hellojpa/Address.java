...
/*
    - 임베디드 타입(사용자 정의 타입) -
    ㆍ임베디드 타입이란? : https://inf.run/6XCw3(17초 ~ 3분 1초) 참고
    ㆍ사용하는 이유(장점) : https://inf.run/6XCw3(3분 23초 ~ 4분 19초) 참고
...
　　      ┗ https://photos.google.com/photo/AF1QipM04HmklmuqUUyvJ3A9JmXnVnddVeJruxQ7nDo1 참고
    */
    ...
    // https://inf.run/DpQGj(5분 29초 ~ 5분 42초) 참고
    @Override
    public int hashCode() {
